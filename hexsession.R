...
torch_tbl <- tibble(
  ...
  local_urls = c(
    ...
    "https://mlverse.github.io/torchdatasets/",
    "https://mlverse.github.io/hfhub/",
    "https://mlverse.github.io/safetensors/",
    "https://github.com/jtleek/scorcher",
...
reticulated_tbl <- tibble(
  packages = c( "mlr3torch", "dsprrr", "tabpfn", "iltm", "tabicl", "tabdpt"),
  local_images = c(
    "images/mlr3torch.png",
    "images/dsprrr.png",
    "images/tabpfn.png",
    "images/iltm.png",
    "images/tabicl.png",
...
fs::file_move(here("temp_hexsession/_hexout.html"),
              here("temp_hexsession/torch.html"))

# reticulated
make_tile(reticulated_tbl, output_dir = here())
snap_tile("images/tile_reticulate.png")
fs::file_move(here("temp_hexsession/_hexout.html"),
              here("temp_hexsession/reticulate.html"))

# nouveautés
make_tile(torch_tbl[18:20, ], output_dir = here())
snap_tile("images/tile_nouveauté.png", screen_width = 600)
fs::file_move(here("temp_hexsession/_hexout.html"),
              here("temp_hexsession/nouveauté.html"))
