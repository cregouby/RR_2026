...
::: notes
500€ / jour d'astreinte et 10k€ de dommage et intérêt piur Carrefour.fr. Source le Monde

Mon niveau d'obligation: rgaa.info/recherche

Réference : https://cecileuzel.com/web-design-le-blog/l-accessibilite-web-etes-vous-hors-la-loi
:::
...
- Les lecteurs d'écran : NVDA / JAWS (MS-Windows),  Orca (Linux), VoiceOver
  (MacOS)
...
- Déclarer explicitement les en-têtes de colonnes et de lignes (balise `<th>`).\  
