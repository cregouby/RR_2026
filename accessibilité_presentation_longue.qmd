...
- Utiliser {cli} pour formater des messages textuels clairs, en fournissant du contexte.

- Pas d'information relayée par les couleurs (Vert = Succès, Rouge = Erreur) sans ajouter de texte ou symbole explicite (✔, ✖).
